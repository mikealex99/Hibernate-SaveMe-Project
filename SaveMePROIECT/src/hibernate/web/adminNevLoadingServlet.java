 ...
 */
@WebServlet("/adminNevLoading")
public class adminNevLoadingServlet extends HttpServlet {
	...
	private void editUser(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {		
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("AdminNevoiasiLoading.jsp");
