...
@WebServlet("/VerifyCodePass")
public class verifyCodePasswordServlet extends HttpServlet {
	...
	private void verify(HttpServletRequest request, HttpServletResponse response) throws SQLException, IOException, ServletException {
         ...
         User user= (User) session.getAttribute("Reauthcode");
         
         String code = request.getParameter("Reauthcode");
         ...
         if(code.equals(user.getCode())){
    		...
    		userDao.updateUser(userupdate);
 	        ...
 	        RequestDispatcher dispatcher = request.getRequestDispatcher("setparola.jsp");
