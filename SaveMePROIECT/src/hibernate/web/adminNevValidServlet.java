 ...
 */
@WebServlet("/adminNevValid")
public class adminNevValidServlet extends HttpServlet {
	...
	private void editUser(HttpServletRequest request, HttpServletResponse response) throws SQLException, ServletException, IOException {		
		...
		RequestDispatcher dispatcher = request.getRequestDispatcher("AdminNevoiasiValid.jsp");
