...
<div class="wrapper">
  <div class="title">Introduceti codul trimis pe adresa de email</div>
  <div class="form">
  
  	<form action="VerifyCodePass2" method="post"> 
      <div class="input_field">
		...
		<input type="hidden" name="Adresa" value="<%=existingUser.getAdresa()%>">
      	<input type="text" placeholder="COD" name="Reauthcode2" class="input" required>
	 ...
	 <span style="margin-left: 40px;">Nu ai primit niciun cod? 
	 	<form action="ReVerifyPass2" method="post">
			<input type="hidden" name="Id_user" value="<%=existingUser.getId()%>">
