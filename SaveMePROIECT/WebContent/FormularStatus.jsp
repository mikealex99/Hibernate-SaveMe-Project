	...
	<nav>
		...
		<ul>
            ...
            <li><form action="CufRedirect" method=post>
               	 		...
               	 		<button type="submit" style="background: none;border:none;color:white;font-weight:bold;font-size:19px;" >Cufarul Magic</button>
               	</form>
            </li>
...
<div class="flip-card-container" style="--hue: 220;margin-left:40%;margin-top:2%;">
  	<div class="flip-card">
    	...
    	<div class="card-back">
      		...
      		<form action="updDirect" method=post>
               	     	<input type="hidden" class="input" name="Id_UserNev" value="<%=existingUser2.getId_UserNev()%>">
               	 		<input type="hidden" class="input"  name="Email" value="<%=existingUser2.getEmail()%>">
               	 		<button type="submit" style="background: none;border:none;color:white;font-weight:bold;font-size:20px;" >Editeaza</button>
        	</form>        		
