...
<input type="text" class="inputID" name="Id" placeholder="<%=nev.getId()%>" value="<%=nev.getId()%>" /><br><br><br>
...
<i class="fas fa-dollar-sign fa" style="color: rgba(255,255,255,0.8);"></i>&nbsp;<label style="color:rgba(255,255,255,0.8); font-size:20px;"> Bani </label>&nbsp;<select name="Bani" class="inputInfo" style="color: black;" >
...
<i class="fa fa-shopping-cart fa" style="color: rgba(255,255,255,0.8);"></i>&nbsp;<label style="color:rgba(255,255,255,0.8);font-size:20px; "> Alimente </label>&nbsp;<select name="Mancare" class="inputInfo" style="color: black;">
...
<i class="fas fa-tshirt fa" style="color: rgba(255,255,255,0.8);"></i>&nbsp;<label style="color:rgba(255,255,255,0.8);font-size:20px; "> Haine </label>&nbsp;<select name="Haine" class="inputInfo" style="color: black;">
...
<i class="fa fa-spinner" style="color: rgba(255,255,255,0.8);"></i>&nbsp;<label style="color:rgba(255,255,255,0.8);font-size:20px; "><%=nev.getStatus()%></label>&nbsp;<label style="color:rgba(255,255,255,0.8);font-size:20px; border-left: 3px solid black; ">&nbsp;Modifica:</label>&nbsp;<select name="Status" class="inputInfo" style="color: black;">
...
<button type="submit" class="btn btn-primary" style="display:inline-block;
	...
	margin-right:110px;
	">Salveaza</button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	<button type="submit" formaction="deleteNevoie" class="btn btn-danger"  style="	margin-bottom:64px;	
	margin-left:100px;" onclick="return confirm('Sunteti sigur ca doriti sa stergeti acest nevoias?')" >Sterge</button>	
